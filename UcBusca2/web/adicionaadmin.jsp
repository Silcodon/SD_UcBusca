...
<s:form action="tornaradmin">
<s:textfield placeholder="Escreva aqui o nome..." id="search" name="usernameadmin"></s:textfield>
<s:submit id="procura" value="Tornar"></s:submit>
</s:form>
</body>
</html>
